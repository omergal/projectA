...
python3 main.py --template EDSR --model EDSR --scale 2 --nFeat 64 --nResBlock 16 --patchSize 96 --load EDSR_baseline_x2 --reset True --dataDir ./../dataset --ext jpg
...
# Training EDSR_x4
#python main.py --template EDSR --model nFeatEDSR_scale --scale 4 --nFeat 256 --nResBlock 32 --patchSize 192 --load EDSR_x4 --reset True
...
#python3 main.py  --testData myImage --scale 2+3+4 --preTrained ../experiment/model/MDSR_baseline.pt --testOnly True --saveResults True --save test_MDSR_baseline --reset True

# Test with MDSR_baseline_jpeg
#python3 main.py  --testData myImage --scale 2+3+4 --preTrained ../experiment/model/MDSR_baseline_jpeg.pt --testOnly True --saveResults True --save test_MDSR_baseline_jpeg --reset True


#NOTE TO OMER AND IDAN: changed scale in EDSR to x1 instead of x4
# Test with EDSR_x4
#python3 main.py  --testData myImage --scale 4 --preTrained ../experiment/model/EDSR_baseline_x4.pt --testOnly True --saveResults True --save test_EDSR_x4 --reset True
